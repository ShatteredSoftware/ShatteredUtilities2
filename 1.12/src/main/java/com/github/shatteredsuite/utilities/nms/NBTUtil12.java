...
public class NBTUtil12 extends NBTUtil {

    private NBTTagCompound checkOrMakeCompound(net.minecraft.server.v1_12_R1.ItemStack stack) {
    ...
    public String getStringNullable(org.bukkit.inventory.ItemStack item, String key) {
        ...
        net.minecraft.server.v1_12_R1.ItemStack stack = CraftItemStack.asNMSCopy(item);
        NBTTagCompound compound = stack.getTag();
        if (hasCompoundAndKey(compound, key, NBTType.STRING)) {
