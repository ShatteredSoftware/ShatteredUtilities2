 ...
 *
 * <p>Enum mapping to sound names for different minecraft versions.
 *
 * @author Nikl
 * @author MrBlobman
 * @since 1.0.0
...
public enum Sound {
    ...
    ZOMBIE_WOODBREAK(
        "ZOMBIE_WOODBREAK", "ENTITY_ZOMBIE_BREAK_DOOR_WOOD", "ENTITY_ZOMBIE_BREAK_WOODEN_DOOR"),
    ...
    FIREWORK_BLAST2(
        "FIREWORK_BLAST2", "ENTITY_FIREWORK_BLAST_FAR", "ENTITY_FIREWORK_ROCKET_BLAST_FAR"),
    ...
    FIREWORK_TWINKLE2(
        "FIREWORK_TWINKLE2", "ENTITY_FIREWORK_TWINKLE_FAR", "ENTITY_FIREWORK_ROCKET_TWINKLE_FAR"),
